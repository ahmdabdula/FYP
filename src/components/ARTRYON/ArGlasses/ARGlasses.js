...
import searchImage from "./target.png";
import AdsPopup from "../../Advertisement/AdsPopup";
...
function AppCanvas(props) {
  ...
  return (
    <div>
      ...
      >
        <canvas className="JeelizVTOWidgetCanvas"></canvas>

        {/* <div
        style={{ position: "fixed", zIndex: "1000" }}
        className="JeelizVTOWidgetControls"
      >
        <button
      ...
      <AdsPopup AdObject={props.AdObject} />
    </div>
  );
}

export { AppCanvas, set_glassesModel };
